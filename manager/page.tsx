...
export default function ManagerPage() {
  ...
  console.log("ManagerPage: Component loaded, user:", user?.email, "isManager:", user?.isManager)
    ...
    if (user?.isManager) {
      ...
      const unsubscribe = onSnapshot(
        ...
        (snapshot) => {
          ...
          console.log("ManagerPage: Processed requests:", requestsData.length)
          setRequests(requestsData)
          setIsLoading(false)
        },
        (error) => {
          console.error("ManagerPage: Error loading requests:", error)
          setIsLoading(false)
        },
      )
  ...
  const createNotificationForBranch = async (
    ...
    try {
      console.log("ManagerPage: Creating notification for branch:", branchCode, "Status:", newStatus)
      ...
      console.log("ManagerPage: Branch notification data:", notificationData)
      const docRef = await addDoc(collection(db, "notifications"), notificationData)
      console.log("ManagerPage: Branch notification created with ID:", docRef.id)
    } catch (error) {
      console.error("ManagerPage: Error creating notification for branch:", error)
    }
  }
  ...
  const handleStatusUpdate = async (requestId: string, newStatus: string, message?: string) => {
    ...
    try {
      ...
      console.log("ManagerPage: Request status updated successfully")
      ...
      console.error("ManagerPage: Error updating status:", error)
      toast({
        title: "Error",
